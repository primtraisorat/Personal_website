...
export function ServicesSection() {
  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-7xl pl-4 sm:pl-8 md:pl-16 lg:pl-24">
        <div
          ...
          {[
            {
              ...
              description: "Shaping ideas into products that solve real problems at scale",
              direction: "top",
            },
            {
              title: "UI/UX & Systems Design",
              description: "Designing interfaces that feel effortless and think for themselves",
              direction: "right",
            },
            {
              title: "Brand, Visuals & Marketing",
              description: "Building identities that command attention and earn loyalty",
              direction: "left",
            },
            {
              title: "Fine Art & Creative Direction",
              description: "Exploring emotion and narrative through visual storytelling",
              direction: "bottom",
            },
          ].map((service, i) => (
